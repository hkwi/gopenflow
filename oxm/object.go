// Package oxm provides oxm utilities used in openflow 1.2 and later.
package oxm
...
const (
	...
	OXM_OF_PBB_UCA        = OFPXMC_OPENFLOW_BASIC<<OXM_CLASS_SHIFT | OFPXMT_OFB_PBB_UCA<<OXM_FIELD_SHIFT
	OXM_OF_TCP_FLAGS      = OFPXMC_OPENFLOW_BASIC<<OXM_CLASS_SHIFT | OFPXMT_OFB_TCP_FLAGS<<OXM_FIELD_SHIFT
	OXM_OF_ACTSET_OUTPUT  = OFPXMC_OPENFLOW_BASIC<<OXM_CLASS_SHIFT | OFPXMT_OFB_ACTSET_OUTPUT<<OXM_FIELD_SHIFT
	OXM_OF_PACKET_TYPE    = OFPXMC_OPENFLOW_BASIC<<OXM_CLASS_SHIFT | OFPXMT_OFB_PACKET_TYPE<<OXM_FIELD_SHIFT
)
